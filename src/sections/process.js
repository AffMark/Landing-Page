...
export default function Process() {
  return (
    <section sx={styles.process} id='process'>
      <Container>
        <SectionHeader
          slogan="Influencer Workflow"
          title="How to get brand partnerships"
          isWhite={true}
        />
